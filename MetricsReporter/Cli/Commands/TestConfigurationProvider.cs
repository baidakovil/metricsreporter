...
/// <summary>
/// Loads configuration for the test command by merging CLI, environment, and file sources.
/// </summary>
internal sealed class TestConfigurationProvider
{
  private readonly MetricsReporterConfigLoader _configLoader;

  /// <summary>
  /// Initializes a new instance of the <see cref="TestConfigurationProvider"/> class.
  /// </summary>
  /// <param name="configLoader">MetricsReporter configuration loader.</param>
  public TestConfigurationProvider(MetricsReporterConfigLoader configLoader)
  {
    _configLoader = configLoader ?? throw new ArgumentNullException(nameof(configLoader));
  }

  /// <summary>
  /// Loads configuration and resolves metric aliases for the test command.
  /// </summary>
  ...
  public ConfigurationLoadResult Load(TestSettings settings)
  {
