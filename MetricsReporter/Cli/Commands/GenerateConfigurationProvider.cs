...
/// <summary>
/// Loads generate command configuration by merging CLI, environment, and file sources.
/// </summary>
internal sealed class GenerateConfigurationProvider
{
  private readonly MetricsReporterConfigLoader _configLoader;

  /// <summary>
  /// Initializes a new instance of the <see cref="GenerateConfigurationProvider"/> class.
  /// </summary>
  /// <param name="configLoader">MetricsReporter configuration loader.</param>
  public GenerateConfigurationProvider(MetricsReporterConfigLoader configLoader)
  {
    _configLoader = configLoader ?? throw new ArgumentNullException(nameof(configLoader));
  }

  /// <summary>
  /// Loads configuration for the generate command and resolves metric aliases.
  /// </summary>
  /// <param name="settings">Generate CLI settings.</param>
  /// <returns>Configuration load result with resolved options and aliases.</returns>
  ...
  public ConfigurationLoadResult Load(GenerateSettings settings)
  {
